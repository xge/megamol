 ...
 */
#ifndef VRINTEROP_H_INCLUDED
#define VRINTEROP_H_INCLUDED
...
#ifdef VRINTEROP_EXPORTS
#define VRINTEROP_API __declspec(dllexport)
#else
#define VRINTEROP_API __declspec(dllimport)
#endif
#else /* _WIN32 */
#define VRINTEROP_API
#endif /* _WIN32 */
 ...
 * @return 200 -- (ver.: 2.00)
 */
VRINTEROP_API int mmplgPluginAPIVersion(void);
 ...
 */
VRINTEROP_API void mmplgReleasePluginCompatibilityInfo(
 ...
 */
VRINTEROP_API void mmplgReleasePluginInstance(
