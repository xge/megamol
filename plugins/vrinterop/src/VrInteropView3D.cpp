 ...
 */
VrInteropView3D::VrInteropView3D(void)
    : View3D()
 ...
 */
void VrInteropView3D::Render(const mmcRenderViewContext& context) {
	updateParameters();
...
void  megamol::vrinterop::VrInteropView3D::renderFromCamera(const CameraOpenGL & viewCamera, const mmcRenderViewContext& context)
{
...
void megamol::vrinterop::VrInteropView3D::doBboxDataShare(const mmcRenderViewContext& context)
{
...
void  megamol::vrinterop::VrInteropView3D::broadcastFramebuffer(FramebufferObject& fbo, interop::TextureSender& sender)
{
...
void megamol::vrinterop::VrInteropView3D::updateParameters()
{
...
bool megamol::vrinterop::VrInteropView3D::isNewFbSize(unsigned int width, unsigned int height)
{
...
/*
 * vrinterop::VrInteropView3D::Resize
 */
void VrInteropView3D::Resize(unsigned int width, unsigned int height) {
	Base::Resize(width, height);
}

/*
 * vrinterop::VrInteropView3D::OnRenderView
 */
bool VrInteropView3D::OnRenderView(Call& call) {
	Base::OnRenderView(call);
    return true;
}

/*
 * vrinterop::VrInteropView3D::create
 */
bool VrInteropView3D::create(void) {
	Base::create();
...
/*
 * vrinterop::VrInteropView3D::release
 */
void VrInteropView3D::release(void) {
	Base::release();
...
void VrInteropView3D::applyCameraConfig(CameraOpenGL& cam, const interop::CameraView& view, const interop::CameraProjection proj, interop::ModelPose& pose)
{
